...
public class DisplayEncodedImage extends AppCompatActivity {
	...
	private String fname,lname,UserId,name,email,Database_Path = "All_Encoded_Images";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_encoded_image);
		...
		recyclerView.setLayoutManager(new LinearLayoutManager(DisplayEncodedImage.this));
		progressDialog = new ProgressDialog(DisplayEncodedImage.this);
		...
		databaseReference.addValueEventListener(new ValueEventListener() {
			...
			public void onDataChange(@NotNull DataSnapshot snapshot) {
				...
				adapter = new DecodeRecyclerViewAdapter(getApplicationContext(), list);
